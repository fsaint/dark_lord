...
- Provider execution now accepts only the opaque validated call and no caller-supplied scope; resource sets are defensively copied at snapshot construction.
